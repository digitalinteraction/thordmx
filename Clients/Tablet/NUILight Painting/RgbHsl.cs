...
namespace IPS.TabletPainting
{
    public class RgbHsl
    {
        ...
        public static HSL RGB_to_HSL(System.Windows.Media.Color c)
        {
            System.Drawing.Color col = System.Drawing.Color.FromArgb(c.A, c.R, c.B, c.G);

            HSL hsl = new HSL();
            
            hsl.H = col.GetHue() / 360.0; // we store hue as 0-1 as opposed to 0-360
            hsl.L = col.GetBrightness();
            hsl.S = col.GetSaturation();
